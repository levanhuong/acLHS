...
`aclhs` ([Le et al., 20xx](https://github.com/vargaslab/acLHS)) implements the autocorrelated conditioned Latin Hypercube Sampling algorithm for 1 dimensional (i.e., time-series) and 2 dimensional (i.e., spatial) data with independent and dependent variable values.
...
1. Cite [Le et al. (2024)](https://www.sciencedirect.com/science/article/pii/S0098300424000220) in the references.
